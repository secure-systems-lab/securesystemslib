...
class TestSchema(unittest.TestCase):
  ...
  def test_Schema(self):
    ...
    self.assertRaises(ssl_commons_exceptions.FormatError, new_schema2.check_match, 'bad')
    self.assertFalse(new_schema2.matches('bad'))
    self.assertTrue(new_schema2.matches('test'))
   
    # Test conditions for invalid arguments.
    self.assertRaises(ssl_commons_exceptions.FormatError, new_schema2.check_match, True)
    self.assertRaises(ssl_commons_exceptions.FormatError, new_schema2.check_match, NewSchema2)
    self.assertRaises(ssl_commons_exceptions.FormatError, new_schema2.check_match, 123)
  ...
  def test_String(self):
    ...
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.String, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.String, [1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.String, {'a': 1})
  ...
  def test_OneOf(self):
    ...
    # Test conditions for invalid arguments in a schema definition.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.OneOf, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.OneOf, [1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.OneOf, {'a': 1})
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.OneOf, [SCHEMA.AnyString(), 1])
  ...
  def test_AllOf(self):
    ...
    # Test conditions for invalid arguments in a schema definition.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.AllOf, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.AllOf, [1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.AllOf, {'a': 1})
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.AllOf, [SCHEMA.AnyString(), 1])
  ...
  def test_ListOf(self):
    ...
    # Test conditions for invalid arguments in a schema definition.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.ListOf, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.ListOf, [1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.ListOf, {'a': 1})
  ...
  def test_DictOf(self):
    ...
    # Test conditions for invalid arguments in a schema definition.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.DictOf, 1, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.DictOf, [1], [1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.DictOf, {'a': 1}, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.DictOf, SCHEMA.AnyString(), 1)
  ...
  def test_Optional(self):
    ...
    # Test conditions for invalid arguments in a schema definition.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Optional, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Optional, [1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Optional, {'a': 1})
  ...
  def test_Object(self):
    ...
    object_schema = SCHEMA.Object(a=SCHEMA.AnyString(),
                                      bc=SCHEMA.Struct([SCHEMA.Integer(),
                                                            SCHEMA.Integer()]))
    ...
    # Test conditions for invalid arguments in a schema definition.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Object, a='a')
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Object, a=[1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Object, a=SCHEMA.AnyString(),
                                                          b=1)
  ...
  def test_Struct(self):
    ...
    # Test conditions for invalid arguments in a schema definition.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Struct, 1)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Struct, [1])
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Struct, {'a': 1})
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.Struct,
                      [SCHEMA.AnyString(), 1])
  ...
  def test_RegularExpression(self):
    ...
    # 're_object' is 'None'.)
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.RegularExpression, None, 0,
                                                      None, None)
    ...
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.RegularExpression, 8)
  ...
  def test_LengthString(self):
    ...
    # Test conditions for invalid arguments.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.LengthString, 'hello')
  ...
  def test_LengthBytes(self):
    ...
    # Test conditions for invalid arguments.
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.LengthBytes, 'hello')
    self.assertRaises(ssl_commons_exceptions.FormatError, SCHEMA.LengthBytes, True)
