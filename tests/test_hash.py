...
if (
    "hashlib"  # pylint: disable=unneeded-not
...
class TestHash(unittest.TestCase):  # pylint: disable=missing-class-docstring
    ...
    def _run_with_all_algos_and_libs(self, test_func):  # pylint: disable=missing-function-docstring
        algorithms = [
            "sha224",
            "sha256",
            "sha384",
    ...
    def _do_algorithm_update(self, library, algorithm):  # pylint: disable=missing-function-docstring
        expected = {
            "blake2b": [
    ...
    def _do_digest_size(self, library, algorithm):  # pylint: disable=missing-function-docstring
        digest_sizes = {
            "sha224": 28,
            "sha256": 32,
            "sha384": 48,
    ...
    def _do_update_filename(self, library, algorithm):  # pylint: disable=missing-function-docstring
        data = "abcdefgh" * 4096
    ...
    def _do_update_filename_normalize(self, library, algorithm):  # pylint: disable=missing-function-docstring
        data = b"ab\r\nd\nf\r" * 4096
    ...
    def _do_update_file_obj(self, library, algorithm):  # pylint: disable=missing-function-docstring
        data = "abcdefgh" * 4096
