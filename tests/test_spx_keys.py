...
<Purpose>
  Test cases for test_spx_keys.py.
"""
...
logger = logging.getLogger('securesystemslib.test_spx_keys')
...
class TestSPX_keys(unittest.TestCase):
  def setUp(self):
    pass
  ...
  def test_verify_signature(self):
    ...
    self.assertRaises(securesystemslib.exceptions.FormatError,
        securesystemslib.spx_keys.verify_signature, public, 123,
        signature, data)

    # Invalid signature method.
    self.assertRaises(securesystemslib.exceptions.FormatError,
        securesystemslib.spx_keys.verify_signature, public,
        'unsupported_scheme', signature, data)

    # Signature not a string.
    self.assertRaises(securesystemslib.exceptions.FormatError,
        securesystemslib.spx_keys.verify_signature, public, scheme,
        123, data)
