...
# "compat" schema exists so verifying old, incorrect, GPG signatures works
GPG_DEPRECATED_SIGNATURE_SCHEMA = SCHEMA.Object(
    object_name="GPGP_SIGNATURE_SCHEMA",
    keyid=KEYID_SCHEMA,
    short_keyid=SCHEMA.Optional(KEYID_SCHEMA),
    other_headers=HEX_SCHEMA,
...
GPG_COMPAT_SIGNATURE_SCHEMA = SCHEMA.OneOf(
    [GPG_DEPRECATED_SIGNATURE_SCHEMA, GPG_SIGNATURE_SCHEMA]
)
