...
GPG_VERSION_COMMAND = gpg_version_command()
...
GPG_SIGN_COMMAND = gpg_sign_command("{keyarg}", "{homearg}")
...
GPG_EXPORT_PUBKEY_COMMAND = gpg_export_pubkey_command("{homearg}", "{keyid}")
